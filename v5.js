...
(function () {
  ...
  ready(function () {
    ...
    function answer(q) {
      ...
      if (/bundle|package|deal|all of it|everything/.test(s)) return "Three line passes: <b>Core $750/mo</b> (six products), <b>Pro $1,395/mo</b> (adds the AI receptionist, Echo and Marquee), <b>Custom $2,500/mo</b> (everything + your custom website + a named strategist).<br><a href='/#bundles'>See the bundles →</a>";
