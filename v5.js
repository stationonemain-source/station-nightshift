...
(function () {
  ...
  ready(function () {
    ...
    function answer(q) {
      ...
      if (/bundle|package|deal|all of it|everything/.test(s)) return "Three line passes: <b>Core $750/mo</b> (six products), <b>Pro $1,395/mo</b> (adds the AI receptionist, Echo and Marquee), <b>Custom $2,500/mo</b> (everything + the $500 Storefront website + a named strategist).<br><a href='/#bundles'>See the bundles →</a>";
      if (/website|web site|site/.test(s)) return "Storefront: <b>$500 + $49/mo</b> premium build live in 48 hours, or a <b>Custom</b> build priced by evaluation. Real examples you can click:<br><a href='/portfolio/'>Open the portfolio →</a>";
