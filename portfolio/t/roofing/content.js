/* Elite Roofing & Solar — the ONE content file.
...
window.GABLE_CONTENT = {
  brand: {
    mark: '<img class="wm-logo" src="assets/logo.png" alt="Elite Roofing & Solar">',
    markOnly: false,
    name: 'ELITE ROOFING & SOLAR',
    legal: 'Elite Roofing & Solar',
    tagline: 'The roof over everything.',
    sub: 'Replacement, repair and storm restoration — built to outlive the warranty.',
    kicker: 'Roofing · Denver, CO',
    city: 'Denver',
    phone: '(303) 296-0361',
    email: 'inquiries@elite-roofs.com',
    license: 'CO Licensed & Insured · GAF Master Elite',
    founded: ''
  },
  ...
  beats: [
    ...
    { id: 'finale', in: 0.87, peak: 0.93, out: 2, tone: 'light', anchor: 'left',
      ...
      body: '2,400 roofs across Denver. Inspected free. Built once.',
      ctas: [
  ...
  manifesto: {
    ...
    accent: 'once',
    body: 'ELITE ROOFING & SOLAR is a crew-owned roofing company: our estimators climbed ladders before ' +
  ...
  stats: [
    { n: 2400, suffix: '+', label: 'roofs across greater Denver' },
  ...
  work: {
    ...
    items: [
      { name: 'The Hartley House', place: 'Denver',
  ...
  system: {
    kicker: 'The system',
    title: 'What a ELITE ROOFING & SOLAR roof is made of.',
    ...
    steps: [
      ...
      { title: 'Walkthrough & warranty', weeks: 'Day 3',
        body: 'Magnet-swept lawn, photographed result, manufacturer warranty registered in your name.' }
    ]
  },
  ...
  financing: {
    kicker: 'Financing',
    title: 'Priced after the inspection.',
    body: 'Financing available through partner lenders, approvals inside a day. ' +
  ...
  testimonials: [
    { quote: 'Worked with Doug today for a post-solar inspection (wanted to make sure our 3rd party solar installer didn\'t mess up our roof). He did a very thorough job, found a…', name: 'aab 33717 — Denver, CO' },
    { quote: 'Our salesman Doug was wonderful. He was kind, knowledgeable, and always available for any questions or concerns I had. The workers arrived on time, and all work would…', name: 'Diane Daugherty — Denver, CO' },
    { quote: 'I had a great experience. My clients needed to have a roof done by a specific date for a real estate contract. Elite roofers (Cody) was so easy to communicate with. I…', name: 'Brittany & Julie Ouimette — Denver, CO' }
  ],

  areasLabel: 'Serving',
  areas: ['Denver', 'Surrounding communities'],
