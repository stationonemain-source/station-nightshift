/* Dorian Pools & Construction — the ONE content file.
...
window.GLASS_CONTENT = {
  brand: {
    mark: '<img class="wm-logo" src="assets/logo.png" alt="Dorian Pools & Construction">',
    markOnly: true,
    name: 'DORIAN POOLS & CONSTRUCTION',
    legal: 'Dorian Pools & Construction',
    tagline: 'Water, held still.',
    sub: 'Design-build pools & outdoor living for the greater El Paso area.',
    kicker: 'Custom pools · El Paso, TX',
    city: 'El Paso',
    ...
    region: 'TX',
    phone: '(915) 778-5111',
    email: 'hello@dorianpoolsconstruction.com',
  ...
  beats: [
    { id: 'hero',   in: -0.1, peak: 0,     out: 0.09,
      kicker: 'Custom pools · El Paso, TX', title: 'Water, held still.',
      body: 'Design-build pools & outdoor living for the greater El Paso area.' },
    ...
    { id: 'ch2',    in: 0.30, peak: 0.36,  out: 0.44,
      ...
      body: 'Engineered for expansive El Paso area clay, and built to outlast the house.' },
  ...
  manifesto: {
    ...
    body: 'DORIAN POOLS & CONSTRUCTION is a design-build studio: one team from the first sketch to the first swim. ' +
  ...
  builds: {
    ...
    items: [
      ...
      { name: 'Mirror Ridge', place: 'El Paso',
  ...
  testimonials: [
    { quote: 'Dorian and Construction absolutely exceeded our expectations. From start to finish, their professionalism, communication, and attention to detail were top tier. They…', name: 'Daniel Garcia — El Paso, TX' },
    { quote: 'Amazing Experience with Dorian Construction -- Pools & Waterfalls From the very first moment I reached out to Dorian Construction, I knew I was choosing a company that…', name: 'ma Jimenez — El Paso, TX' },
    { quote: 'We had a great experience with Dorian Pools and Construction in El Paso, Texas. From the first conversation to the final result, everything was smooth and stress-free…', name: 'Ramon Eduardo Valdés — El Paso, TX' }
  ],

  areas: ['El Paso', 'Surrounding communities'],
